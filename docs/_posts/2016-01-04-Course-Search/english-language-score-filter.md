...
endpoint: '/api/course-search/filter/english-language-score'
title: 'English Language Filter'
type : 'POST'
...
**Endpoint** : **`URL`** /api/course-search/filter/english-language-score
...
```{
  ...
  "status": "success",
  "message": "cost list",
  "actor": "/api/course-search/filter/english-language-score",
  "hostname": [hostname]",
  "reference_data": [
  {
    "id": "IELTS",
